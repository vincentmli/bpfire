...
'dns error 0' => '<strong>第一个</strong>DNS服务器地址无效，请检查设置！<br /><strong>第二个</strong>DNS服务器地址有效。',
'dns error 01' => '<strong>第一</strong>和<strong>第二</strong>DNS服务器地址无效，请重新检查设置！',
'dns error 1' => '<strong>第二个</strong>DNS服务器地址无效，请重新检查设置！<br /><strong>第一个</strong>DNS服务器地址有效。',
...
'dns use isp assigned nameservers' => '使用ISP分配DNS服务器',
...
'email tls' => 'TLS模式',
'email tls explicit' => '显式(STARTTLS)',
'email tls implicit' => '隐含(TLS)',
...
'host deny' => '拒绝的主机列表',
'host ip' => '主机IP地址',
'host to net vpn' => '主机到网络虚拟专用网络（RoadWarrior）',
...
'mac desc' => '这里可以更改red0上的MAC地址。 地址必须以十六进制（0-9，a-f）输入。 <br />例如： 00-01-02-0e-b8-d6 或 00:01:02:0e:b8:d6。',
'mac filter' => 'MAC过滤器',
'mac new' => '新的MAC地址:',
...
'loxilb lb config added' => 'LoxiLB 负载均衡 配置添加',
'loxilb lb config entries' => 'LoxiLB 负载均衡配置',
'loxilb lb edit' => '修改负载均衡配置',
...
'loxilb lb eport' => '后端端口',
'loxilb lb monitor' => '后端服务监控',
'loxilb fw' => 'eBPF LoxiLB 防火墙配置',
'loxilb fw changed' => '防火墙配置被修改',
'loxilb fw entries' => '当前防火墙配置',
'loxilb fw edit' => '编辑防火墙 ',
'loxilb fw add' => '添加防火墙',
'loxilb fw sourceIP' => '源网络地址CIDR',
'loxilb fw destinationIP' => '目的网络地址CIDR',
'loxilb fw minSourcePort' => '源网络最小端口',
'loxilb fw maxSourcePort' => '源网络最大端口',
'loxilb fw minDestinationPort' => '目的网络最小端口',
'loxilb fw maxDestinationPort' => '目的网络最大端口',
'loxilb fw proto' => '网络协议',
...
'keepalived' => '高可用性',
'keepalived config' => 'Keepalived 配置',
'keepalived status' => 'Keepalived 运行状态',
'keepalived state' => '主备状态',
'keepalived virtual router id' => '虚拟路由 ID',
'keepalived priority' => '优先级',
'keepalived advert int' => '广告间隔',
'keepalived garp master delay' => 'Garp 主设备延迟',
...
'ipblocklist category' => '类型',
'ipblocklist category application' => '应用',
'ipblocklist category attacker' => '攻击者',
'ipblocklist category c and c' => '恶意软件 C&amp;C',
'ipblocklist category composite' => '合成',
'ipblocklist category invalid' => '无效地址',
'ipblocklist category reputation' => '声誉',
'ipblocklist category scanner' => '扫描器',
'ipblocklist could not download blocklist' => '不能下载黑名单',
'ipblocklist download error' => '下载错误。',
'ipblocklist empty blocklist received' => '已收到一个空的阻止列表。',
'ipblocklist enable' => '启用',
'ipblocklist hits' => '黑名单命中总数',
'ipblocklist id' => '黑名单',
'ipblocklist input' => '丢弃的数据包 (进)',
'ipblocklist log' => '记录丢弃的数据包',
'ipblocklist log list' => '防火墙日志（黑名单）',
'ipblocklist logs' => 'IP 地址黑名单日志',
'ipblocklist name' => '名称',
